...
class Main
{
    ...
    public function __construct()
    {
        ...
        $incomesManager = new IncomesManagerByPayPalTransferWithBigCredit(new IncomesCalculationService($paypalUser), new TaxesCalculationService($paypalUser), new IncomesTransferService($paypalUser));
